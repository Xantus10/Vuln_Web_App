...
<form action="" method="post">
  ...
  <label for="title">Titulek komentáře</label><br>
  <input type="text" name="title" id="title" required><br>
  <label for="cont">Obsah komentáře</label><br>
...
<form action="" method="post">
  ...
  <input type="submit" value="Odstranit všechny příspěvky">
</form>
 ...
 */
if (isset($_GET["aderr"])) {
  echo "<p class=\"red\">Musíte mít role=admin pro provedení této akce!</p>";
}
?>
